...
<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
    ...
    <div class="border-div">
        ...
        <c:url value='<%= AcquistoCreditiController.RQ_CONFERMA_ORDINE_CREDITI%>' var="filterFormActionUrl"/>
        <div class="row">
        ...
        <form:form method="POST" modelAttribute="invoiceData" id="bol-hbol-lista-strutture-filtro-form" action="${filterFormActionUrl}" class="form-horizontal table">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6" style="padding:0px;">
                        <label class="col-xs-2 col-sm-2 col-md-2 col-lg-2 control-label" for="tel">
                            Tel *
                        </label>
    ...
    <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2 ">
        <div class="border-div">
            <div class="nav navbar-default left-navbar" style="margin-left: 0px;">
                ...
                <c:if test='${criteriPagamento.tipoPagamento == "BANK"}'>
                    <center>
                        <input type="submit" name="submit" value="Paga Con Bonifico" />
                    </center>
                </c:if>
                <br>
            </div>
