...
<div id="img-group">
    <div class="row" id="butt-gr">
        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
            <h4> Immagini della Struttura</h4>
        </div>
        <div class=" col-xs-4  col-sm-4  col-md-4  col-lg-4">
            ...
            <button class="btn btn-primary btn-sm btn-file" ng-click="uploadImmagine(struttura.id)">Carica foto</button>  
        </div>
        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
            <button class="btn btn-danger btn-sm" ng-click="eliminaFotoSelezionate()">Elimina foto selezionate</button>   
        </div>
    </div>
