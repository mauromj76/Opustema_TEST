...
<html lang="it">
    <head>
        ...
        <title>Booking Online - Crediti Maturandi</title>
    </head>
    <body>
        <%@ include file="../layout/bol-header.jsp"%>
        <div  ng-app="CreditiMaturandiApp">
            <script>
                var app = angular.module('CreditiMaturandiApp', []);
            </script>
                ...
                <div class="container-fluid" id="customer-home-container">
                    <div class="row">
                        ...
                        <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9 ">
                            <%@ include file="layout/crediti-maturandi-table.jsp" %>
