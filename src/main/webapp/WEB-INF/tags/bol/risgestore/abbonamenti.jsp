...
<html>
    <head>
        ...
        <title>PrenotazioneAule.it - Gestione abbonamenti</title>
    ...
    <body>
        <div ng-app="AbbonamentiManagement">
            <script>
                var app = angular.module('AbbonamentiManagement', []);
            </script>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                        <%@include file="layout/edit-abbonamenti-table.jsp" %>
                    </div>
                </div>
